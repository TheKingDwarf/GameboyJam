...
if sound==-1{
    sound = ds_map_create();//map_Create("pitch",0,"vol",0,"playid",obj.play_id);
...
var specsnd = container_attribute(con,"specmin");
...
//random pitch
var pitch_min = container_attribute(con,"pitchmin",obj),pitch_max = container_attribute(con,"pitchmax",obj);
...
if type==1{
        ...
        ds_map_Replace(sound,"delayout",container_attribute(con,"lpdelay",obj));//ds_map_Find_value(con,"lpdelay"));
    }
